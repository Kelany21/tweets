...
<div class="topbar">
        ...
        @else
            <div class="dropdown" id="kt_quick_search_toggle">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    @include('dashboard.layout.partials.extras.dropdown._search-dropdown')
                </div>
            </div>
        @endif
    @endif
    ...
    @if (config('layout.extras.notifications.display'))
        ...
        @else
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        @include('dashboard.layout.partials.extras.dropdown._notifications')
                    </form>
                </div>
            </div>
        @endif
    ...
    @if (config('layout.extras.quick-actions.display'))
        ...
        @else
            <div class="dropdown">
                ...
                {{-- Dropdown --}}
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    @include('dashboard.layout.partials.extras.dropdown._quick-actions')
                </div>
            </div>
        @endif
    @endif
    ...
    @if (config('layout.extras.cart.display'))
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                <form>
                    @include('dashboard.layout.partials.extras.dropdown._cart')
                </form>
            </div>
        </div>
    @endif
    ...
    {{-- Languages --}}
    @if (config('layout.extras.languages.display') && count(LaravelLocalization::getSupportedLocales()) > 1)
        <div class="dropdown">
            <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                @include('dashboard.layout.partials.extras.dropdown._languages')
            </div>
        </div>
    @endif
            ...
            <div class="topbar-item">
                <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2"
                    ...
                    <span class="symbol symbol-35 symbol-light-success">
                        <span
                            class="symbol-label font-size-h5 font-weight-bold">{{ substr(auth()->user()->name , -1) }}</span>
                    </span>
                </div>
            </div>
        @else
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    @include('dashboard.layout.partials.extras.dropdown._user')
                </div>
            </div>
        @endif
    @endif
