...
@section('content')
    <form action="{{ uA($moduleRoute.'/'.$row->id) }}" method="post" multiple="">
        ...
        @component('components.dashboard.layout._subheader-v1' , ['toolBar' => $toolBar ,'moduleRoute' => $moduleRoute  ,'counts' => $counts, 'moduleName' => $moduleName  , 'createBtnIcon' => $createBtnIcon , 'page_breadcrumbs' => $page_breadcrumbs])
