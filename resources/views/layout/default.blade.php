...
{{--    {{ Metronic::getGoogleFontsInclude() }}--}}
    ...
    @foreach(config('website-layout.resources.css') as $style)
...
@if (config('website-layout.page-loader.type') != '')
...
<script>
    var KTAppSettings = {!! json_encode(config('website-layout.js'), JSON_PRETTY_PRINT|JSON_UNESCAPED_SLASHES) !!};
</script>

{{-- Global Theme JS Bundle (used by all pages)  --}}
@foreach(config('website-layout.resources.js') as $script)
